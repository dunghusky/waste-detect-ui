...
const getVideoDetailProcessDataAPI = () => {
  return axios.get(
    "/api/v1/details_process_video/video_detail_process_data",
    {}
  );
};
...
export {
  getWasteDataAPI,
  getVideoProcessDataAPI,
  getWasteCategoryDataAPI,
  getCameraDataAPI,
  getVideoDetailProcessDataAPI,
  getModelCategoryDataAPI,
};
